...
const SocialLoginButtons: FC<SocialLoginButtonsProps> = ({
  ...
  const handleDiscordLogin = async () => {
    ...
    await signIn('discord', { callbackUrl: '/workspaces' });
  };

  const handleLinkedInLogin = async () => {
    setIsLoading('linkedin');
    await signIn('linkedin', { callbackUrl: '/workspaces' });
  };
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', width: '100%' }}>
      ...
      >
        <span style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <GoogleIcon />
          {isLoading === 'google' ? 'Weiterleitung...' : 'Mit Google fortfahren'}
        </span>
      </Button>
      ...
      >
        <span style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <DiscordIcon />
          {isLoading === 'discord' ? 'Weiterleitung...' : 'Mit Discord fortfahren'}
        </span>
      </Button>
      ...
      >
        <span style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <LinkedInIcon />
          {isLoading === 'linkedin' ? 'Weiterleitung...' : 'Mit LinkedIn fortfahren'}
        </span>
      </Button>
