...
import { Button as ButtonComponent, Link } from './Button.styles';
...
import { RippleHandle } from '../../ripple/component/Ripple.types';
...
const Button = forwardRef<HTMLButtonElement | HTMLAnchorElement, ButtonProps>(
  (props, ref) => {
    ...
    return isLink ? (
      ...
      <ButtonComponent ref={buttonRef} type={type} {...sharedProps}>
        <div>
          {icon && (
            <div className="icon">
              {/* icon ist IconProps-Objekt */}
